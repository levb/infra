...
func main() {
	...
	if *memfile {
		baseHeaderFile = baseTemplate.HeaderPath("memfile")
		diffHeaderFile = diffTemplate.HeaderPath("memfile")
	} else {
		baseHeaderFile = baseTemplate.HeaderPath("rootfs.ext4")
		diffHeaderFile = diffTemplate.HeaderPath("rootfs.ext4")
	}
